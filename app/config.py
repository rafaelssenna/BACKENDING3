...
try:
    ...
    class Settings(BaseSettings):
        ...
        # Retry & Resilience (otimizado para Railway)
        MAX_RETRIES: int = 5
        RETRY_DELAY_MS: int = 3000
        NAVIGATION_TIMEOUT: int = 90000
        SELECTOR_WAIT_TIMEOUT: int = 20000
        MAX_EMPTY_PAGES: int = 40
        CAPTCHA_COOLDOWN_BASE: int = 40
        CAPTCHA_MAX_COOLDOWN: int = 300
    ...
    class Settings:
        ...
        def __init__(self) -> None:
            ...
            self.RETRY_DELAY_MS: int = int(os.getenv("RETRY_DELAY_MS", "3000"))
            self.NAVIGATION_TIMEOUT: int = int(os.getenv("NAVIGATION_TIMEOUT", "90000"))
            self.SELECTOR_WAIT_TIMEOUT: int = int(os.getenv("SELECTOR_WAIT_TIMEOUT", "20000"))
            self.MAX_EMPTY_PAGES: int = int(os.getenv("MAX_EMPTY_PAGES", "40"))
            self.CAPTCHA_COOLDOWN_BASE: int = int(os.getenv("CAPTCHA_COOLDOWN_BASE", "40"))
            self.CAPTCHA_MAX_COOLDOWN: int = int(os.getenv("CAPTCHA_MAX_COOLDOWN", "300"))
